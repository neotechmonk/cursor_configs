...
from src.core.sessions.trading_session import TradingSessionImpl, SessionConfig, SymbolMapping, ExecutionLimits
...
def test_session_initialization(trading_session):
