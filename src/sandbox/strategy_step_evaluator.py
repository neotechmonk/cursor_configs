"""Strategy step evaluation and execution module.

This module provides functionality for evaluating individual strategy steps,
including argument preparation, result mapping, and context updates.
"""
...
@dataclass
class StepEvaluator:
    """Evaluates a single strategy step using a pure function and configuration.
    ...
    def evaluate(self, price_feed: pd.DataFrame, execution_context: StrategyExecutionContext, **config_params) -> StrategStepEvaluationResult:
        ...
        Args:
            price_feed: Price data to evaluate
            execution_context: Current execution context
            **config_params: Additional configuration parameters
            
        Returns:
            Evaluation result containing success status and outputs
        """
        try:
